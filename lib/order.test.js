...
describe('order', ()=>{
    ...
    beforeEach(()=>{
        warnStub = sandbox.stub(console, 'warn');// want to check if it actually gets called
        ...
        o = new Order(123, user, items);// it will make this o instance available in all tests
    })
    ...
    it('should update status to active and return order details', ()=>{
        ...
        expect(dateSpy).to.have.been.calledThrice;// in the constructor it gets called twice already and again in the test so it should be 3 times
